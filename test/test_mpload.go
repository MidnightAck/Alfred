...
func main() {
	username := "admin"
	token := "f025308508db34312592eb7f17b2ce4b5e8c537e"
	filehash := "8ad919f746fd8a56a176687df8f3e47b8754fe52"
	...
	// 3. 请求分块上传接口
	filename := "/home/crowfea/Downloads/morya-perkeep-master.zip"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"27262976"},
			"filename": {"morya-perkeep-master.zip"},
			"uploadid": {uploadID},
		})
